...
### Debug (коли приходять пусті items)
```bash
curl "http://localhost:8000/trending?refresh=true&method=cloudscraper&storage_file=storage_dumps/state_usd.json&debug=true"
```
